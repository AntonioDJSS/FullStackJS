...
const Cliente = ({cliente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        <p className="font-bold uppercase text-indigo-700 my-1">Folio de Validacion: {' '}
            <span className="font-normal normal-case text-black">{_id}</span>
        </p>
        <p className="font-bold uppercase text-indigo-700 my-1">Nombre: {' '}
            <span className="font-normal normal-case text-black">{nombre}</span>
        </p>
        <p className="font-bold uppercase text-indigo-700 my-1">Apellidos: {' '}
        ...
        <p className="font-bold uppercase text-indigo-700 my-1">Fecha de Finalizacion: {' '}
            <span className="font-normal normal-case text-black">{formatearFecha(fechaFinalizacion)}</span>
        </p>
        <p className="font-bold uppercase text-indigo-700 my-1">Certificado: {' '}
